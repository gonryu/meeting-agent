...
1. 좌측 메뉴 **Slash Commands** → **Create New Command** 로 아래 커맨드 등록:
...
5. **Slash Commands** → 아래 커맨드 모두 등록 (Socket Mode에서는 Request URL 불필요):
