...
- briefing: {{"start_date": "YYYY-MM-DD", "end_date": "YYYY-MM-DD", "period_text": "표시용 기간 텍스트"}} — 자연어 기간을 날짜 범위로 변환
  ...
  - "브리핑 해줘" / "오늘 미팅 현황" → start_date=오늘, end_date=오늘, period_text="오늘"
  - "내일 일정" → start_date=내일, end_date=내일, period_text="내일"
  - "이번주 일정 브리핑" → start_date=오늘, end_date=이번주 토요일, period_text="이번주"
  - "다음주 일정" → start_date=다가오는 일요일, end_date=그 다음 토요일, period_text="다음주"
  - "이번달 일정" → start_date=오늘, end_date=이번달 말일, period_text="이번달"
  - "다음달 일정" → start_date=다음달 1일, end_date=다음달 말일, period_text="다음달"
  - "앞으로 3일 일정" → start_date=오늘, end_date=오늘+2일, period_text="향후 3일"
  - "앞으로 2주" → start_date=오늘, end_date=오늘+13일, period_text="향후 2주"
  - 기간 언급 없으면 → start_date=오늘, end_date=오늘, period_text="오늘"
  - 주(week)의 기준: 일요일~토요일
